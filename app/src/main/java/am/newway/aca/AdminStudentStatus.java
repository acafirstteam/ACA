...
public
class AdminStudentStatus extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    void onCreate ( Bundle savedInstanceState ) {
        ...
        if ( customspinner != null ) {
            ...
            customspinner.setOnItemSelectedListener( new AdapterView.OnItemSelectedListener() {
                @Override
                public
                void onItemSelected ( final AdapterView<?> adapterView , final View view ,
    ...
    private
    ArrayList<CustomItemSpinner> getCustomList () {
        customList = new ArrayList<>();
        //Spiner for lvl
        customList.add(
                new CustomItemSpinner( "LVL zero junior" , R.drawable.ic_school_black_24dp ) );
        customList.add(
                new CustomItemSpinner( "LVL zero junior" , R.drawable.ic_school_green_24dp ) );
        customList.add(
                new CustomItemSpinner( "LVL one middle" , R.drawable.ic_school_middle_24dp ) );
        customList.add(
                new CustomItemSpinner( "LVL two senior" , R.drawable.ic_school_senior_24dp ) );
        customList.add(
                new CustomItemSpinner( "LVL three master" , R.drawable.ic_school_master_24dp ) );
    ...
    private
    ArrayList<CustomItemSpinner> getCustomListTwo () {
        ...
        customListTwo.add(
                new CustomItemSpinner( "Introduction to Python" , R.drawable.ic_python ) );
