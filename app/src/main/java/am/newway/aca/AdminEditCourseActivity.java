...
class AdminEditCourseActivity extends BaseActivity implements View.OnClickListener {
    ...
    private TextInputEditText editGroupNameEng;
    private TextInputEditText editGroupNameArm;
    private TextInputEditText editDescriptionEng;
    private TextInputEditText editDescriptionArm;
    private TextInputEditText editLink;
    private TextInputEditText editLecturer;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        groupTypeRadioGroup = findViewById(R.id.admin_edit_radioGroup_id);
        typeBeginner = findViewById(R.id.admin_edit_radio_0);
        typeSpecialized = findViewById(R.id.admin_edit_radio_1);
        typeAdvanced = findViewById(R.id.admin_edit_radio_2);

        setImage = (ImageView) findViewById(R.id.admin_edit_imageView_id);
        setImage.setOnClickListener(this);

        final FloatingActionButton saveButton = findViewById(R.id.admin_edit_Save_btn_id);
